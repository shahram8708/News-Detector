        ...
        if response and 'candidates' in response:
            ...
            if story_content:
                if is_safe_content(safety_ratings):
                    ...
                    error_msg = "Failed to Detect News content due to safety concerns. Please try again with a different query."
                    return render_template('index.html', error=error_msg)
        error_msg = "Failed to Detect News content. Please try again."
        return render_template('index.html', error=error_msg)
    else:
        error_msg = "Please enter a valid News Article or Headline prompt."
        return render_template('index.html', error=error_msg)
